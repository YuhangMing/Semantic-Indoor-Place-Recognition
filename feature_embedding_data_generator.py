...
if __name__ == '__main__':
    ...
    for task in tasks:
        ...
        for j, scene in enumerate(scenes):
            printProgressBar(j+1, nScenes, prefix=task+' - '+scene, suffix='Complete', length=50)
        ...
        printProgressBar(nScenes, nScenes, prefix=task+' - '+scene, suffix='Complete', length=50, printEnd='\n')
        print(task, ':', pcd_count)
            ...
            #     frame_id_idx[i] = frame_count
            #     frame_count += 1

            # scene_dict[scene] = frame_id_idx

    # # Change from actual frame id to index
    # # i.e. divide by 15. PROBLEM there are skipped frames
    # # get map from scene data and map from frame_id to index
    # for task in tasks:
    #     print(task)

    #     with open(os.path.join(scannet_path, 'VLAD_triplets', 'Real_Frame_ID', 'vlad_'+task+'.txt'), 'rb') as f:
    #         scenes_pn = pickle.load(f)

    #     # new_scenes_pn = {}
    #     # for scene_name, list_of_pairs in scenes_pn.items():
    #     #     new_list_of_pairs = []
    #     #     for pairs in list_of_pairs:
    #     #         new_pos = []
    #     #         for frame_id in pairs[0]:
    #     #             # print(frame_id)
    #     #             # print(type(frame_id))
    #     #             new_pos.append(int(frame_id/15))
    #     #         new_neg = []
    #     #         for frame_id in pairs[1]:
    #     #             new_neg.append(int(frame_id/15))
    #     #         new_list_of_pairs.append((new_pos, new_neg))
            
    #     #     new_scenes_pn[scene_name] = new_list_of_pairs

    #     new_scenes_pn = {}
    #     for scene_name, list_of_pairs in scenes_pn.items():
    #         map_dict = scene_dict[scene_name]
    #         new_list_of_pairs = []
    #         for pairs in list_of_pairs:
    #             new_pos = []
    #             for frame_id in pairs[0]:
    #                 # print(frame_id)
    #                 # print(type(frame_id))
    #                 new_pos.append(map_dict[frame_id])
    #             new_neg = []
    #             for frame_id in pairs[1]:
    #                 new_neg.append(map_dict[frame_id])
    #             new_list_of_pairs.append((new_pos, new_neg))
            
    #         new_scenes_pn[scene_name] = new_list_of_pairs
        
    #     with open(os.path.join(scannet_path, 'vlad_'+task+'.txt'), 'wb') as vlad_file:
    #         pickle.dump(new_scenes_pn, vlad_file)
    ...
    # print(len(scenes_pn))
    # one_scene_pos_neg = scenes_pn['scene0003_01']
    # print(one_scene_pos_neg[9][0])
    # print(one_scene_pos_neg[9][1])
    # print('In total', len(one_scene_pos_neg), 'pos', len(one_scene_pos_neg[9][0]), 'neg', len(one_scene_pos_neg[9][1]))
    # print()

    # with open(os.path.join(scannet_path, 'VLAD_triplets', 'Real_Frame_ID', 'vlad_training.txt'), 'rb') as f:
    #     scenes_pn = pickle.load(f)
