...
if __name__ == '__main__':
    ...
    with open('results/Recog_Log_2021-06-18_21-54-24/training.txt') as f:     # Adam 0.0001, 5 features
        lines = f.readlines()
        tmp = 0
        for line in lines:
    ...
    with open('results/Recog_Log_2021-06-20_12-47-14/training.txt') as f:     # Adam 0.0001, 2 features
        lines = f.readlines()
        tmp = 0
        for line in lines:
            line = line.rstrip().split(' ')
